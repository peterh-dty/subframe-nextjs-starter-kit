...
/*
 * Documentation:
 * Select — https://app.subframe.com/069ea454afb9/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeCore.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-border bg-default-background group-focus-within/bb88f90b:border-2 group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-500",
              {
